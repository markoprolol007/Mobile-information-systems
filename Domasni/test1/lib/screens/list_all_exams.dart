...
class ListAllExamsScreen extends StatelessWidget {
  ...
  List<Exam> get exams => [
    Exam(
      ...
      dateTime: DateTime(2025, 1, 12, 9, 0),
      rooms: ['AMF', 'LAB 2'],
    ),
    Exam(
    ...
    Exam(
      ...
      dateTime: DateTime(2025, 1, 8, 8, 0),
      rooms: ['AMF'],
    ),
    Exam(
      examName: 'Вештачка интелигенција',
      dateTime: DateTime(2025, 1, 20, 13, 0),
      rooms: ['LAB 1'],
    ),
    Exam(
      examName: 'Бази на податоци',
      dateTime: DateTime(2025, 1, 17, 9, 0),
      rooms: ['LAB 3'],
    ),
    Exam(
    ...
    Exam(
      ...
      dateTime: DateTime(2025, 2, 2, 10, 0),
      rooms: ['LAB 6', 'AMF'],
    ),
    Exam(
